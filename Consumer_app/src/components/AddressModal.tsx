...
export const AddressModal = ({ open, onClose, onSave, loading }: AddressModalProps) => {
  ...
  const handleSaveAddress = async (e?: React.FormEvent) => {
    ...
    // Note: We don't save here directly anymore to avoid double-saving
    // as the parent (Checkout) also handles the save via mutation.
    onSave(newAddress);
    // Reset and close is handled by parent on success, 
    // but we can reset form here if needed.
  };
