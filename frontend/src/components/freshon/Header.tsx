  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-background/85 backdrop-blur-md">
      <div className="container flex h-16 items-center gap-3 md:h-20 md:gap-6">
        ...
        <Link to="/pride" className="hidden items-center gap-1.5 rounded-full bg-harvest px-4 py-1.5 text-xs font-bold text-harvest-foreground shadow-sm hover:bg-harvest/90 transition-all md:flex animate-pulse">
        ...
        <button
          ...
          className="hidden h-10 w-10 place-items-center rounded-full hover:bg-surface md:grid disabled:opacity-50"
          aria-label="Profile"
        >
            ...
            <nav className="mt-6 grid gap-2">
              ...
              <SheetClose asChild>
                <button
                  onClick={handleProfileClick}
                  disabled={isLoadingUser}
                  className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-semibold hover:bg-surface disabled:opacity-50"
                >
